...
impl DynamicMetricBuilder {
    ...
    fn get_service_provider(&self, service_type: &AwsService) -> Result<&dyn MetricProvider> {
...
pub fn build_metric_data(core: CoreMetrics, advanced: AdvancedMetrics) -> MetricData {
    MetricData {
        ...
        // Missing new fields with default values for first function
        ...
        // RDS Instance characteristics - not included in legacy function
        instance_characteristics: None,
    }
}

/// Build MetricData with instance characteristics for intelligent filtering
pub fn build_metric_data_with_characteristics(
    core: CoreMetrics, 
    advanced: AdvancedMetrics,
    characteristics: Option<super::metric_types::RdsInstanceCharacteristics>
) -> MetricData {
    MetricData {
        timestamps: core.timestamps,
        cpu_utilization: core.cpu_utilization,
        ...
        // Missing new fields with default values for second function
        cpu_surplus_credit_balance: 0.0,
        cpu_surplus_credit_balance_history: Vec::new(),
        cpu_surplus_credits_charged: 0.0,
        cpu_surplus_credits_charged_history: Vec::new(),
        ...
        // RDS Instance characteristics for intelligent filtering
        instance_characteristics: characteristics,
    }
}
...
/// ```
pub fn build_from_service_metrics(service_metrics: ServiceMetrics) -> Result<MetricData> {
    let builder = DynamicMetricBuilder::new();
