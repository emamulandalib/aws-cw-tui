...
impl UniversalBox {
    ...
    pub fn empty_with_suggestion<S: Into<String>, T: Into<String>>(mut self, message: S, suggestion: T) -> Self {
        self.content_type = BoxContent::Empty {
            message: message.into(),
    ...
    pub fn render_with_state(self, f: &mut Frame, area: Rect, list_state: Option<&mut ListState>) {
        ...
        match self.content_type {
            BoxContent::Text { text, alignment, wrap, style_override } => {
            ...
            BoxContent::List { items, list_state: internal_state, highlight_style } => {
            ...
            BoxContent::Empty { message, suggestion } => {
...
impl UniversalBox {
    ...
    /// Create an info box
    pub fn info<S: Into<String>, T: Into<String>>(title: S, message: T, theme: UnifiedTheme) -> Self {
        Self::new(theme.clone())
            .title(title)
    ...
    pub fn success<S: Into<String>, T: Into<String>>(title: S, message: T, theme: UnifiedTheme) -> Self {
        Self::new(theme.clone())
            .title(title)
    ...
    pub fn warning<S: Into<String>, T: Into<String>>(title: S, message: T, theme: UnifiedTheme) -> Self {
        Self::new(theme.clone())
            .title(title)
    ...
    /// Create an error box
    pub fn error_box<S: Into<String>, T: Into<String>>(title: S, message: T, theme: UnifiedTheme) -> Self {
        Self::new(theme.clone())
            .title(title)
            .error(message)
    }
    ...
    pub fn loading_box<S: Into<String>, T: Into<String>>(title: S, message: T, theme: UnifiedTheme) -> Self {
        Self::new(theme.clone())
            .title(title)
            .loading(message)
    }
